...
makeup, setup and overall effects.</li>
        ...
        <br />
        <br />
        <a href = "https://docs.google.com/forms/d/e/1FAIpQLSe5bUCW5O483a7xbfxs5fs0mxTLLTqlHwsibu_IXv_NL8qSDw/viewform"><button class = "button button1">Register</button></a>
        <br />
        <br />
    </div>
        <FooterNoMap/>
