...
export default class GeolocateControl extends BaseControl {
  constructor(...args) {
    ...
    _defineProperty(this, "_setupMapboxGeolocateControl", supportsGeolocation => {
      ...
      if (this._mapboxGeolocateControl.options.trackUserLocation && this._mapboxGeolocateControl._geolocateButton) {
      ...
      if (this._mapboxGeolocateControl.options.trackUserLocation) {
        this._context.eventManager.on('panstart', () => {
          if (this._mapboxGeolocateControl._watchState === 'ACTIVE_LOCK') {
            ...
            this._mapboxGeolocateControl._geolocateButton.classList.add('mapboxgl-ctrl-geolocate-background');

            this._mapboxGeolocateControl._geolocateButton.classList.remove('mapboxgl-ctrl-geolocate-active');
          }
        });
      }
